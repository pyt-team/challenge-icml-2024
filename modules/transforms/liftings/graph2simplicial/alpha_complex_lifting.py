...
from modules.data.utils.utils import SimplexData, compute_invariance_r_minus_1_to_r, compute_invariance_r_to_r, get_complex_connectivity


def alpha_lift(graph: torch_geometric.data.Data, dim: int, fc_nodes: bool = True) -> SimplicialComplex:
    pos = graph.pos 
...
class BaseSimplicialAlphaLifting(Graph2SimplicialLifting):
    ...
    def lift_topology(self, data: torch_geometric.data.Data) -> dict:
        ...
        simplicial_complex = alpha_lift(data, self.complex_dim)
...
class SimplicialAlphaComplexLifting(BaseSimplicialAlphaLifting):
...
class SimplicialInvariantAlphaComplexLifting(BaseSimplicialAlphaLifting):
